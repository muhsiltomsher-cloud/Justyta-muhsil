...
class RatingsExport implements FromArray, WithHeadings, WithStyles, WithEvents
{
    protected $request;
    ...
    {
        $query = Rating::query()->orderBy('id', 'desc');
        ...
        return $query->get([
                    ...
                    return [
                        ...
                        'Date'  => \Carbon\Carbon::parse($contact->created_at)->format('d-m-Y h:i A'),
                    ];
                })->toArray();
    }
    ...
    {
        return ['Sl No.', 'Name', 'Email', 'Phone', 'Rating', 'Comment', 'Date'];
    }
