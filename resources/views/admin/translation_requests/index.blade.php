        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Legal Translation Requests</h4>
                            ...
                            <form method="GET" action="{{ route('legal-translation-requests.index') }}" autocomplete="off">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-3 mb-1 mt-2 d-flex flex-wrap align-items-end">
                                        ...
                                        @can('export_translation_requests')
                                            <a href="{{ route('legal-translation-requests.export', ['service_id' => request('service_id')] + request()->all()) }}" class="btn btn-warning btn-sm ml-2">
                                                Export
                                            </a>
                                        @endcan
                                    </div>
                                ...
                                <table class="table table-bordered table-basic mb-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge badge-pill {{ $statusClass[$serviceReq->status] ?? 'badge-secondary' }}">
                                                        {{ ucwords(str_replace('_', ' ', $serviceReq->status)) ?? ucfirst($serviceReq->status) }}
                                                    </span>
                                                </td>
                                        ...
                                        @if ($serviceRequests->isEmpty())
                                            <tr>
                                                <td colspan="8" class="text-center">No translation requests found.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
