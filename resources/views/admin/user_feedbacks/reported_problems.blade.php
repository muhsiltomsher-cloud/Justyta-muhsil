@extends('layouts.admin_default', ['title' => 'Reported Problems'])
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Reported Problems</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table4  bg-white mb-20">
                            ...
                            <form method="GET" action="{{ route('user-reported-problems.feedback') }}" autocomplete="off">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-3 mb-1 mt-2 d-flex flex-wrap align-items-end">
                                        ...
                                        @can('export_reported_problems')
                                            <a href="{{ route('user-reported-problems.export', request()->query()) }}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-basic mb-0">
                                    <thead class="userDatatable-header">
                                        <tr>
                                            ...
                                            <th class="text-center ">Attatchment</th>
                                            <th class="text-center w-10">Date</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        
                                        @forelse($problems as $key => $prbm)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    data-content='
                                                            <div class="custom-popover">
                                                                ...
                                                                <div class="popover-item"><i class="fas fa-envelope"></i> {{ $prbm->user?->email }}</div>
                                                                <div class="popover-item"><i class="fas fa-phone"></i> {{ $prbm->user?->phone }}</div>
                                                            </div>
                                                        '></i>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ asset(getUploadedImage($prbm->image)) }}" data-lightbox="image{{ $key }}">
                                                        <img src="{{ asset(getUploadedImage($prbm->image)) }}"  alt="{{ $prbm->subject }}" width="50" class="mb-1" />
                                                    </a> 
                                                </td>

                                                <td class="text-center">{{ date('d, M Y h:i A', strtotime($prbm->created_at)) }}</td>
                                            </tr>
                                        @empty
                                            <tr>
                                ...
                                <div class="aiz-pagination mt-4">
                                    {{ $problems->appends(request()->input())->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
