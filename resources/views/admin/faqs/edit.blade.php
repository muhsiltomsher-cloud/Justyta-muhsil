@extends('layouts.admin_default', ['title' => 'Edit FAQ'])
            ...
            <div class="col-lg-12 mx-auto">
                <div class="card card-horizontal card-default card-md mb-4">
                    <div class="card-header">
                        <h5 class="mb-0 h4">Edit FAQ Details</h5>
                    </div>
                    <div class="card-body pb-md-30">
                        <form class="form-horizontal row" autocomplete="off" action="{{ route('faqs.update', $faq->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                           <div class="col-md-6 mb-3">
                                <label class="col-form-label color-dark fw-500 align-center">Sort Order</label>
                                <input type="number" name="sort_order" id="typeSort" value="{{ old('sort_order', $faq->sort_order) }}"
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="tab-content custom-tab-content" id="langTabsContent">
                                    @foreach ($languages as $lang)
                                        @php 
                                            $trans = $translations[$lang->code] ?? null;
                                        @endphp
                                        ...
                                        <div class="tab-pane fade @if ($loop->first) show active @endif"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" @if ($lang->rtl == 1) dir="rtl" @endif
                                                    ...
                                                    class="form-control ih-small ip-gray radius-xs b-light px-15"
                                                    value="{{ old('translations.' . $lang->code . '.question', $trans->question ?? '') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="translations[{{ $lang->code }}][answer]" @if ($lang->rtl == 1) dir="rtl" @endif
                                                    ...
                                                    rows="10">{{ old('translations.' . $lang->code . '.answer', $trans->answer ?? '') }}</textarea>
