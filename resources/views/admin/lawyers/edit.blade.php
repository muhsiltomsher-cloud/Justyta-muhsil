@extends('layouts.admin_default', ['title' => 'Edit Lawyers'])
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Edit Lawyer</h4>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="tab-pane fade @if ($loop->first) show active @endif"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" @if ($lang->rtl == 1) dir="rtl" @endif
                                                                ...
                                                                value="{{ old('translations.' . $lang->code . '.name', $trans->full_name ?? '') }}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="law_firm" class="form-control select2 ih-small ip-gray radius-xs b-light px-15">
                                                ...
                                                @foreach($lawfirms as $lf)
                                                    <option value="{{ $lf->id }}" {{ old('law_firm', $lawyer->lawfirm_id) == $lf->id ? 'selected' : '' }}>
                                                        {{ $lf->law_firm_name ?? '-' }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="dob" placeholder="d M Y"
                                                ...
                                                value="{{ old('dob', $lawyer->date_of_birth ? \Carbon\Carbon::parse($lawyer->date_of_birth)->format('d F Y') : '') }}">
                                            @error('dob')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="emirates_id_expiry" placeholder="d M Y"
                                                ...
                                                value="{{ old('emirates_id_expiry', $lawyer->emirate_id_expiry ? \Carbon\Carbon::parse($lawyer->emirate_id_expiry)->format('d F Y') : '') }}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="residence_visa_expiry" placeholder="d M Y"
                                                class="form-control ih-small ip-gray radius-xs b-light px-15 datepicker"
                                                value="{{ old('residence_visa_expiry', $lawyer->residence_visa_expiry ? \Carbon\Carbon::parse($lawyer->residence_visa_expiry)->format('d F Y') : '') }}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="passport_expiry" placeholder="d M Y"
                                                class="form-control ih-small ip-gray radius-xs b-light px-15 datepicker"
                                                value="{{ old('passport_expiry', $lawyer->passport_expiry ? \Carbon\Carbon::parse($lawyer->passport_expiry)->format('d F Y') : '') }}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div id="bar_cardPreview" class="mt-2"
                                                @if ($lawyer->bar_card == null) style="display:none;" @endif>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="bar_card_expiry" placeholder="d M Y"
                                                class="form-control ih-small ip-gray radius-xs b-light px-15 datepicker"
                                                value="{{ old('bar_card_expiry', $lawyer->bar_card_expiry ? \Carbon\Carbon::parse($lawyer->bar_card_expiry)->format('d F Y') : '') }}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label color-dark fw-500 align-center">Ministry Of Justice Practicing Lawyer Card</label>
                                            ...
                                            @enderror
                                             ...
                                             <div id="practicing_lawyer_cardPreview" class="mt-2"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="practicing_lawyer_card_expiry" placeholder="d M Y"
                                                class="form-control ih-small ip-gray radius-xs b-light px-15 datepicker"
                                                value="{{ old('practicing_lawyer_card_expiry', $lawyer->practicing_lawyer_card_expiry ? \Carbon\Carbon::parse($lawyer->practicing_lawyer_card_expiry)->format('d F Y') : '') }}">
